...
public class DataDriven_TC extends BaseClass{
	...
	{
		Path filePath = Paths.get(System.getProperty("user.dir"), "RH_FrameWork",  "Utilites", "data.json");
 ...
 * HashMap<String,String>(); map.put("emailId", "testtom@test.com");
 * map.put("passWord", "Test@8795"); map.put("productName", "ZARA COAT 3");
 * 
 * HashMap<String, String> map1 = new HashMap<String, String>();
 * map1.put("emailId", "testtom@test.com"); map1.put("passWord", "Test@8795");
